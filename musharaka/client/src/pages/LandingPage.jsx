...
const FEATURES = [
  ...
  },
  {
    icon: '💬',
    title: 'المساعد الذكي',
    desc: 'أرسل وتابع مبيعاتك مباشرةً عبر المحادثة بالعربية.',
...
const STEPS = [
  {
    num: '01',
    title: 'مشاركه مبيعات بكل سلاسه',
    desc: 'يدوياً، أو عبر استيراد Excel، أو مباشرة من المساعد الذكي — المرونة الكاملة.',
    icon: '📝',
  },
  {
    num: '02',
    ...
    >
      ...
      >
        ...
        >
          ...
          <div>
            <div>تواصل مع الدعم</div>
            <div style={{ fontSize: 13, color: TOKENS.textSec, fontWeight: 400 }}>تيليجرام</div>
          </div>
        </a>
        <a
